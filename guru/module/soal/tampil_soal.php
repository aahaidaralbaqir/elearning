    <div class="col-xs-12 col-lg-12">
        ...
        <div class="box">
            ...
            <!-- /.box-header -->
            <form action="index.php?module=soal" method="POST">
            <div class="box-body">
                        ...
                        echo "<tr><td colspan='8'>Tidak ada soal<td><tr>";
                          ...
                          while($data = $query->FETCH(PDO::FETCH_LAZY)){ ?>
                              <tr>
                               ...
                               <td><?= $data["jawaban"];?></td>
                              <td><a href="module/soal/hapus_soal.php?id_soal=<?= $data['id_soal']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a> <a href="?module=ubah_soal&id_soal=<?= $data["id_soal"]; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a></td>
                              </tr>
                         <?php  $no++; }
                      }
